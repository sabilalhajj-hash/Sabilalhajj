  ...
  if (!mounted) {
    return (
      <div className="bg-emerald-50 py-4 px-4 sm:px-6 lg:px-8 flex justify-center items-center border-b">
        <h1 className="font-bold flex items-center gap-2 text-lg sm:text-xl">{t('Loading...')}</h1>
      </div>
    );
  }
  const colorClasses = {
      ...
      <section className="p-4 sm:p-6 lg:p-8 bg-slate-50 border-b border-gray-200">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 bg-white p-4 sm:p-6 rounded-xl shadow-sm">
            <div className="w-full lg:w-1/3">
              <img src={hotelImage} alt="Hotel" className="rounded-full object-cover w-full h-40 sm:h-48 lg:h-56" />
            </div>
      ...
      <section className="p-4 sm:p-6 lg:p-8">
        <div className="max-w-6xl mx-auto">
          <div className="py-4 sm:py-6 text-center">
            ...
            <p className="text-emerald-600 text-sm sm:text-base mt-2 font-medium">{mounted ? t('itinerary.spiritual_journey') : '...'}</p>
          </div>
